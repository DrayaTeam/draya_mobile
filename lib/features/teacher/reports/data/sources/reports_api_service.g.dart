...
class _ReportsApiService implements ReportsApiService {
  ...
  @override
  Future<PerformanceReportModel> getPerformanceReport(String studentId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PerformanceReportModel>(
    ...
    late PerformanceReportModel _value;
    try {
      _value = PerformanceReportModel.fromJson(_result.data!);
    } on Object catch (e, s) {
