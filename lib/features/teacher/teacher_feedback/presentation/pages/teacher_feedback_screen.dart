...
import "package:draya_mobile/features/teacher/teacher_feedback/presentation/widgets/teacher_feedback_classroom_card.dart";
...
class _TeacherFeedbackScreenState extends State<TeacherFeedbackScreen> {
  ...
  void initState() {
    super.initState();
    context.read<TeacherFeedbackCubit>().loadTeacherClassrooms();
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: "تقييمات الطلاب"),
      drawer: AppDrawer(drawerItemsList: getTeacherDrawerItemsList()),
      backgroundColor: AppColors.background,
      body: BlocConsumer<TeacherFeedbackCubit, TeacherFeedbackState>(
        ...
        builder: (context, state) {
          ...
          if (state.status == CubitStatus.error && state.classrooms.isEmpty) {
            return _ErrorState(
              message:
                  state.apiErrorModel?.error?.message ?? "تعذر تحميل الفصول.",
              onRetry: () =>
                  context.read<TeacherFeedbackCubit>().loadTeacherClassrooms(),
            );
          }
              ...
              children: [
                ...
                ...classrooms.asMap().entries.map((entry) {
                  ...
                  final card = Padding(
                    ...
                    child: TeacherFeedbackClassroomCard(
                      classroom: classroom,
                      onTap: () => context.push(
                        AppRoutes.teacherClassroomFeedbackPage(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "اختر فصلاً لعرض تقييمات وملاحظات طلابه.",
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "أنشئ فصلاً دراسياً لتتمكن من استقبال تقييمات الطلاب.",
              textAlign: TextAlign.center,
              style:
                  AppTextStyles.body.copyWith(color: AppColors.textSecondary),
            ),
