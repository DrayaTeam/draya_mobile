              ...
              children: [
                ...
                Expanded(
                  child: state.status == CubitStatus.loading && teachers.isEmpty
                      ? const Center(child: AppCustomLoading(text: 'جاري تحميل المعلمين...'))
  ...
  List<TeacherModel> _filterTeachers(List<TeacherModel> teachers) {
    ...
    return teachers.where((teacher) {
      final matchesQuery =
          ...
          teacher.email?.toLowerCase().contains(query) == true ||
          teacher.specialization!.toLowerCase().contains(query);
