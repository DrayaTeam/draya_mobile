...
part of 'teacher_profile_api_service.dart';
...
class _TeacherProfileApiService implements TeacherProfileApiService {
  _TeacherProfileApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<void> updateTeacherProfile(
    ...
    _data.addAll(updateTeacherRequestModel.toJson());
