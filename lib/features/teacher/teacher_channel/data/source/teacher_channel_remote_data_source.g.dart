...
part of 'teacher_channel_remote_data_source.dart';
...
class _TeacherChannelRemoteDataSource
    implements TeacherChannelRemoteDataSource {
  _TeacherChannelRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
